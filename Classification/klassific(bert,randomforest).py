...
def classify_texts(embeddings, true_labels):
    # Инициализация классификатора RandomForest
...
# Классификация и оценка для каждого набора эмбеддингов
...
with open('classification_results(Bert,randomforest).txt', 'w') as f:
